...
PickupsScene.prototype.Init = function(){
  ...
  this.bonuses.push(new Pickup(1500,150,50,50,this.fruits[2],'cherries'));
  this.bonuses.push(new Pickup(1550,150,50,50,this.fruits[2],'cherries'));
  this.bonuses.push(new Pickup(1600,150,50,50,this.fruits[2],'cherries'));
  this.bonuses.push(new Pickup(2000,150,50,50,this.fruits[1],'carrot'));
  this.bonuses.push(new Pickup(2050,200,50,50,this.fruits[1],'carrot'));
  this.bonuses.push(new Pickup(2100,250,50,50,this.fruits[1],'carrot'));
